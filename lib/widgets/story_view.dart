...
class StoryItem {
  ...
  factory StoryItem.url({
    ...
    return StoryItem(
      StoryItemContainer(
        ...
        captionOuterPadding: captionOuterPadding,
        shown: shown,
        duration: duration,
      ),
      shown: shown,
  ...
  //                       ],
  //                     ),
  //                     // errorImage: "https://hobbystation.co",
  ...
  factory StoryItem.pageVideo(
    ...
    // VideoPlayerController _videoControllers = VideoPlayerController.network(url)      ..initialize().then((_) {
    //  duration1 = controller.value.duration;
    //   })
